...
sub_400135 -->Calcul la longueur de l'input 
sub_400146--> Fais certaine operation : 
			-->prend  chaque caracteres de notre input - i + 0x14
			-->Compare ensuite au fichier .m.key
